...
class YACUAIOBVO_MessageParcelCell: UITableViewCell {
    ...
    func YACUAIOBVO_BIND_DATA(_ YACUAIOBVO_DATA: YACUAIOBVO_ChatEntity) {
        YACUAIOBVO_NAME_LBL.text = YACUAIOBVO_DATA.YACUAIOBVO_USER_NAME
        YACUAIOBVO_MOTTO_LBL.text = YACUAIOBVO_DATA.YACUAIOBVO_USER_MOTTO
        YACUAIOBVO_AVATAR_FRAME.image = UIImage(named: "YACUAIOBVO_AVATAR_PLACEHOLDER")
