...
class YACUAIOBVO_SafetyActionSheet: UIViewController {
    ...
    private func YACUAIOBVO_STAGING_UI() {
        ...
        let YACUAIOBVO_REPORT_BTN = YACUAIOBVO_GENERATE_ACTION(YACUAIOBVO_TITLE: "Report", YACUAIOBVO_COLOR: .darkGray, YACUAIOBVO_TAG: 101)
        let YACUAIOBVO_BLOCK_BTN = YACUAIOBVO_GENERATE_ACTION(YACUAIOBVO_TITLE: "Block", YACUAIOBVO_COLOR: .darkGray, YACUAIOBVO_TAG: 102)
        let YACUAIOBVO_CANCEL_BTN = YACUAIOBVO_GENERATE_ACTION(YACUAIOBVO_TITLE: "Cancel", YACUAIOBVO_COLOR: .white, YACUAIOBVO_BG: UIColor(red: 1.0, green: 0.58, blue: 0.52, alpha: 1.0), YACUAIOBVO_TAG: 103)
